...
void parteDeclaracaoSubRotinas(FILE *file);
void declaracaoProced(FILE *file);
void chamadaProced(FILE *file);
void chamadaFunc(FILE *file);
void secaoParametrosFormais(FILE *file);
void parametrosFormais(FILE *file);
...
void bloco(FILE *file)
{
    ...
    if (!strcmp(atual.val, "procedure")){
        parteDeclaracaoSubRotinas(file);
    }    
